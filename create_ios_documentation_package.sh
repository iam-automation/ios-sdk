# To run script, run this script within the ios-sdk folder:
# ./create_ios_documentation_package.sh <SDK version number i.e. 5.1.0>

#!/bin/bash

PUBLIC_REPO_NAME="tuneinc"
...
--github_url https://github.com/${PUBLIC_REPO_NAME}/ios-sdk/tree/${LATEST_GIT_TAG}/sdk-ios \
--github-file-prefix https://github.com/${PUBLIC_REPO_NAME}/ios-sdk/blob/${LATEST_GIT_TAG} \
--module Tune \
